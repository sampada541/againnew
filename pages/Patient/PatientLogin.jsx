...
const PatientLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // API call to authenticate patient login
      ...
      if (res && res.data.success) {
        ...
        localStorage.setItem("PatientAuth", JSON.stringify(res.data));
        navigate(location.state || "/dashboard/patient-home");
      } else {
        // Display specific error message if login is unsuccessful
        if (res.data && res.data.message === "Wrong email or password.") {
  ...
  return (
    <Layout title="Patient Login - CureConnect">
      <div
      ...
      >
        <form onSubmit={handleSubmit}>
          <h4 className="title">Patient Login Form</h4>
